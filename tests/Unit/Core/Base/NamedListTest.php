 ...
 * Class NamedListTest
 *
 * @see \Payever\Sdk\Core\Base\NamedList
 *
 * @package Payever\Sdk\Core\Base
 */
class NamedListTest extends TestCase
{
     ...
     * @return array
     */
    public static function generalDataProvider()
    {
        return array(
            array(
                array(
    ...
    /**
     * @see \Payever\Sdk\Core\Base\NamedList::add()
     */
     ...
     *
     * @see \Payever\Sdk\Core\Base\NamedList::addAll()
     */
    ...
    /**
     * @see \Payever\Sdk\Core\Base\NamedList::count()
     */
     ...
     * @dataProvider generalDataProvider
     *
     * @see \Payever\Sdk\Core\Base\NamedList::contains()
     */
     ...
     * @dataProvider generalDataProvider
     *
     * @see \Payever\Sdk\Core\Base\NamedList::clear()
     */
     ...
     * @dataProvider generalDataProvider
     *
     * @see \Payever\Sdk\Core\Base\NamedList::remove()
     */
