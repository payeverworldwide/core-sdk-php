...
class MessageEntityTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->entity = $this->getMockForAbstractClass('Payever\Sdk\Core\Base\MessageEntity');
    }

    /**
     * @param array $data
     *
     * @see \Payever\Sdk\Core\Base\MessageEntity::load()
     *
    ...
    /**
     * @see \Payever\Sdk\Core\Base\MessageEntity::isValid()
     */
