 ...
 *
 * @see \Payever\Sdk\Core\Helper\StringHelper
 *
 * @package Payever\Sdk\Core\Helper
 */
class StringHelperTest extends TestCase
{
     ...
     *
     * @see \Payever\Sdk\Core\Helper\StringHelper::underscore()
     */
     ...
     * @return array
     */
    public static function underscoreCasesDataProvider()
    {
        return array(
     ...
     *
     * @see \Payever\Sdk\Core\Helper\StringHelper::camelize()
     */
     ...
     * @return array
     */
    public static function camelizeCasesDataProvider()
    {
        return array(
     ...
     *
     * @see \Payever\Sdk\Core\Helper\StringHelper::jsonDecode()
     */
     ...
     * @return array
     */
    public static function jsonDecodeDataProvider()
    {
        return array(
